...
В дальнейшем для каждого нового клиента необходимо будет просто довавить необходимые сабинтерфейсы на оборудование и добавить xconnectпо аналогии с уже добавленными
...
В какой-то момент я хотел переделать с xconnect на vpls.
Каждый коммутатор в своем vlan и на каждый vlan свой vpls
Раз уж у нас имеются кольца на них можно поробовать перейти на vpls
