...
Сеть управления сейчас завернута в сторону браса но это ограничение обрезанной схемы. В идеале если эта часть внедрена в сеть оператора т е все управление будет уходить на общий сервер доступов и мониторинга.
